        ...
        <section id="reservations" className="py-24 relative overflow-hidden">
            ...
            <div className="container mx-auto px-6 relative z-20 text-white">
                <div className="text-center mb-20">
                    ...
                    <h2 className="text-6xl font-bold mb-6 font-serif bg-gradient-to-r from-yellow-400 via-yellow-500 to-yellow-600 bg-clip-text text-transparent">Make a Reservation</h2>
